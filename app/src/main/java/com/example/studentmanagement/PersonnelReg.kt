...
class PersonnelReg : AppCompatActivity() {
    ...
    lateinit var sqplitedb: SQLiteDatabase
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnRegist.setOnClickListener {
            ...
            sqplitedb = dbManager.writableDatabase
            sqplitedb.execSQL("INSERT INTO personnel VALUES ('" +str_name+"', '"+str_gender+"', '"+str_age+"', '"+str_tel+"')")
            sqplitedb.close()
